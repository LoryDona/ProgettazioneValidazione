...
- Un report può essere creato (nel senso che viene salvato su file) solo se controfirmato da un amministrativo e se completo di tutti i dati necessari. Per controfirmare è necessario entrare come amministratore e controfirmare il report nell'apposita pagina (link See reports).
